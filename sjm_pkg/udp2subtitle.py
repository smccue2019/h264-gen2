...
#        os.mkdir('Subtitles', 0o0755)
#        os.mkdir('Metadata', 0o0755)
...
#        if ( (self.cruiseid != self.prior_cruiseid) or (self.loweringid != self.prior_loweringid) ):
        srtoutpath = ("/h264Data/Subtitles/"+self.cruiseid+"/"+self.loweringid)
        txtoutpath = ("/h264Data/Metadata/"+self.cruiseid+"/"+self.loweringid)
